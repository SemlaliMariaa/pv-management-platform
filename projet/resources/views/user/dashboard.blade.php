        ...
        <div class="w-full max-w-7xl bg-white rounded-2xl shadow-soft overflow-hidden animate-hover">
            ...
            <div class="px-8 py-8 space-y-8 text-right">
                ...
                <div class="text-center relative">
                    <div class="absolute -left-10 top-1/2 transform -translate-y-1/2 w-16 h-1 bg-indigo-200 rounded-full hidden md:block"></div>
                    <div class="absolute -right-10 top-1/2 transform -translate-y-1/2 w-16 h-1 bg-indigo-200 rounded-full hidden md:block"></div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl border-r-4 border-indigo-500 text-gray-700 mb-8 relative overflow-hidden">
                    <div class="absolute -right-2 -top-2 text-indigo-100 text-5xl z-0">
                        <i class="fas fa-quote-right"></i>
                    </div>
                    <div class="relative z-10">
                        <p class="mb-4 leading-relaxed">
                            في يوم <span class="text-indigo-600 font-semibold">{{ \Carbon\Carbon::now()->locale('ar')->isoFormat('D MMMM YYYY') }}</span>، اجتمعت أعضاء الجمعية
                ...
                <form method="POST" action="{{ route('meeting-members.store') }}">
                    ...
                    <div class="bg-gray-50 rounded-xl border border-gray-200 p-6 mb-10 relative overflow-hidden">
                        ...
                        @if (session('success'))
                            <div class="mb-6 p-4 bg-green-50 border-l-4 border-green-500 text-green-700 rounded-md flex items-start gap-3">
                        ...
                        @error('members'))
                            <div class="mb-6 p-4 bg-red-50 border-l-4 border-red-500 text-red-700 rounded-md flex items-start gap-3">
                        ...
                        <div class="space-y-6">
                            @for ($i = 0; $i < 3; $i++)
                                <div class="grid md:grid-cols-2 gap-6 bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                                    <div>
                        ...
                        <button type="submit" class="mt-6 bg-indigo-600 text-white px-6 py-3 rounded-lg hover:bg-indigo-700 flex items-center gap-2 animate-hover shadow-md">
                ...
                <form method="POST" action="{{ route('needs.store') }}">
                    ...
                    <div class="bg-gray-50 rounded-xl border border-gray-200 p-6 relative overflow-hidden">
                        ...
                        <div class="mt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                            <button id="addRowBtn" type="button" class="bg-indigo-600 text-white px-5 py-2.5 rounded-lg hover:bg-indigo-700 flex items-center gap-2 animate-hover shadow-md w-full sm:w-auto justify-center">
                                <i class="fas fa-plus"></i>
                                <span>إضافة حاجة جديدة</span>
                            </button>

                            <button type="submit" class="bg-indigo-600 text-white px-6 py-2.5 rounded-lg hover:bg-indigo-700 flex items-center gap-2 animate-hover shadow-md w-full sm:w-auto justify-center">
                                <i class="fas fa-save"></i>
